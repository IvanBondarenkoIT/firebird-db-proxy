...
class TestQueryEndpoint:
    ...
    def test_query_without_auth(self, client):
        ...
        response = client.post("/api/query", json={"query": "SELECT 1 FROM RDB$DATABASE"})
    ...
    def test_query_with_invalid_auth(self, client, invalid_auth_headers):
        ...
        response = client.post(
            "/api/query", json={"query": "SELECT 1 FROM RDB$DATABASE"}, headers=invalid_auth_headers
        )
    ...
    def test_query_with_valid_auth_invalid_sql(self, client, auth_headers):
        ...
        response = client.post(
            "/api/query", json={"query": "UPDATE STORGRP SET NAME = 'Test'"}, headers=auth_headers
        )
...
class TestInfoEndpoints:
    ...
    def test_tables_with_invalid_auth(self, client, invalid_auth_headers):
        ...
        response = client.get("/api/tables", headers=invalid_auth_headers)
        assert response.status_code == 401
    ...
    def test_schema_with_invalid_auth(self, client, invalid_auth_headers):
        ...
        response = client.get("/api/schema/STORGRP", headers=invalid_auth_headers)
        assert response.status_code == 401
